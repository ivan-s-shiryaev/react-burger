...
async function refreshAuthToken(argument) {
    ...
    try {
        ...
        try {
            ...
            if (content.message) {
                throw new Error(`Failed to refresh token: ${content.message}. ${error.message}`);
            } else {
                throw error;
            }
            ...
            try {
                ...
                if (content.message) {
                    ...
                    if (refresh && content.message === 'jwt expired') {
                        ...
                        throw new Error(`Failed to get the user: ${content.message}. ${error.message}`);
                    }
                } else {
                    throw error;
                }
    ...
    return async function(dispatch) {
        ...
        try {
            ...
            try {
                ...
                if (content.message) {
                    throw new Error(`Failed to update the user: ${content.message}. ${error.message}`);
                } else {
                    throw error;
                }
    ...
    return async function(dispatch) {
        ...
        try {
            ...
            try {
                ...
                if (content.message) {
                    throw new Error(`Failed to register the user: ${content.message}. ${error.message}`);
                } else {
                    throw error;
                }
    ...
    return async function(dispatch) {
        ...
        try {
            ...
            try {
                ...
                if (content.message) {
                    throw new Error(`Failed to login: ${content.message}. ${error.message}`);
                } else {
                    throw error;
                }
    ...
    return async function(dispatch) {
        ...
        try {
            ...
            try {
                ...
                if (content.message) {
                    throw new Error(`Failed to logout: ${content.message}. ${error.message}`);
                } else {
                    throw error;
                }
    ...
    return async function(dispatch) {
        ...
        try {
            ...
            try {
                ...
                if (content.message) {
                    throw new Error(`Failed to send reset email: ${content.message}. ${error.message}`);
                } else {
                    throw error;
                }
    ...
    return async function(dispatch) {
        ...
        try {
            ...
            try {
                ...
                if (content.message) {
                    throw new Error(`Failed to reset password: ${content.message}. ${error.message}`);
                } else {
                    throw error;
                }
